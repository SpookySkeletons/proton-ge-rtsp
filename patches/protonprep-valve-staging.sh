...
### (2-6) WINE PENDING UPSTREAM SECTION ###
    ...
    # DISABLED: causes hang on xrCreateInstance when no VR runtime is active
...
### (2-6.1) WINE-GST PROTON RTSP SECTION ###
    ...
    echo "WINE: -WINE-GST- 0049-ntdll-Factor-out-bit-search-from-RtlFindClearBits.patch"
    apply_patch "../patches/wine-gst/0049-ntdll-Factor-out-bit-search-from-RtlFindClearBits.patch"

    echo "WINE: -WINE-GST- 0050-ntdll-Factor-out-bit-search-from-RtlFindSetBits.patch"
    apply_patch "../patches/wine-gst/0050-ntdll-Factor-out-bit-search-from-RtlFindSetBits.patch"

    echo "WINE: -WINE-GST- 0051-ntdll-Implement-faster-single-bit-search-into-RtlFin.patch"
    apply_patch "../patches/wine-gst/0051-ntdll-Implement-faster-single-bit-search-into-RtlFin.patch"

    echo "WINE: -WINE-GST- 0052-ntdll-Implement-faster-single-bit-search-into-RtlFin.patch"
    apply_patch "../patches/wine-gst/0052-ntdll-Implement-faster-single-bit-search-into-RtlFin.patch"

    echo "WINE: -WINE-GST- 0053-ntdll-Disable-functionality-of-RtlWalkFrameChain.patch"
    apply_patch "../patches/wine-gst/0053-ntdll-Disable-functionality-of-RtlWalkFrameChain.patch"

    echo "WINE: -WINE-GST- 0054-ntdll-Disable-functionality-of-RtlCaptureStackBackTr.patch"
    apply_patch "../patches/wine-gst/0054-ntdll-Disable-functionality-of-RtlCaptureStackBackTr.patch"

    echo "WINE: -WINE-GST- 0055-ntdll-Do-not-check-handle-in-RtlGrowFunctionTable.patch"
    apply_patch "../patches/wine-gst/0055-ntdll-Do-not-check-handle-in-RtlGrowFunctionTable.patch"

    echo "WINE: -WINE-GST- 0056-TODO-SQUASH-mf-Fix-buffering-in-session.patch"
    apply_patch "../patches/wine-gst/0056-TODO-SQUASH-mf-Fix-buffering-in-session.patch"

    echo "WINE: -WINE-GST- 0057-mf-Use-private-work-queue-in-media-session.patch"
    apply_patch "../patches/wine-gst/0057-mf-Use-private-work-queue-in-media-session.patch"

    echo "WINE: -WINE-GST- 0058-mfsrcsnk-Use-private-work-queue-in-media-source.patch"
    apply_patch "../patches/wine-gst/0058-mfsrcsnk-Use-private-work-queue-in-media-source.patch"

    echo "WINE: -WINE-GST- 0059-kernelbase-Cache-system-info-in-GetSystemInfo-and-Ge.patch"
    apply_patch "../patches/wine-gst/0059-kernelbase-Cache-system-info-in-GetSystemInfo-and-Ge.patch"

    echo "WINE: -WINE-GST- 0060-server-Support-realtime-priority.patch"
    apply_patch "../patches/wine-gst/0060-server-Support-realtime-priority.patch"

    echo "WINE: -WINE-GST- 0061-HACK-ntdll-unix-Set-thread-priority-based-on-thread-.patch"
    apply_patch "../patches/wine-gst/0061-HACK-ntdll-unix-Set-thread-priority-based-on-thread-.patch"

    echo "WINE: -WINE-GST- 0062-treewide-Fix-some-variable-errors-with-Werror.patch"
    apply_patch "../patches/wine-gst/0062-treewide-Fix-some-variable-errors-with-Werror.patch"
