...
### (2-6) PROTON-GE ADDITIONAL CUSTOM PATCHES ###
    ...
    patch -Np1 < ../patches/wine-gst/0039-winegstreamer-Add-a-queue-of-buffers-to-wg_parser-to.patch
    patch -Np1 < ../patches/wine-gst/0040-Revert-winegstreamer-Add-a-queue-of-buffers-to-wg_pa.patch
